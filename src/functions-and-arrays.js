...
function greatestProduct(matrix) {
  ...
  for (let i = 0; i < matrix.length; i++) {
    for (let j = 0; j <= matrix[i].length - 4; j++) {
      const currentProduct = productOfFour(matrix[i][j], matrix[i][j + 1], matrix[i][j + 2], matrix[i][j + 3]);
  ...
  for (let i = 0; i <= matrix.length - 4; i++) {
    for (let j = 0; j < matrix[i].length; j++) {
      const currentProduct = productOfFour(matrix[i][j], matrix[i + 1][j], matrix[i + 2][j], matrix[i + 3][j]);
      maxProduct = Math.max(maxProduct, currentProduct);
    }
  }
