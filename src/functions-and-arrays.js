...
let largest = maxOfTwoNumbers(8, 5);
console.log("maximum of two numbers: "+largest);
...
// should return: 5.7
console.log("average: " + avg(mixedArr));
...
let countword = howManyTimes(wordsCount, "matter");
