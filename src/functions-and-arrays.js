...
function maxOfTwoNumbers() {
  ...
  console.log("The max of two numbers is " + max)
}
maxOfTwoNumbers();
...
const allSum = sumNumbers();
console.log("The sum of the numbers is:", allSum)



// Iteration #3.1 Bonus:

var mixedArr = [6, 12, 'miami', 1, true, 'barca', '200', 'lisboa', 8, 10];
function sum(arr) {
  let total = 0;
...
console.log(averageLength); // This will print the average word length to the console
...
const exists = doesWordExist(words, searchWord);
console.log(exists);
...
var wordsCount = 'matter';

const count = howManyTimes(words, wordsCount);
console.log(count);
...
var result = greatestProduct(matrix);
console.log(result); //print the greatest product of four adjacent numbers
...
// const result = greatestProductOfDiagonals(matrix);
// console.log(result);
