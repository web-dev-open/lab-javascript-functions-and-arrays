...
console.log(maxOfTwoNumbers(20,65));
...
function doesWordExist(wordsFind,a) {
    if (wordsFind.includes(a)){
    return "True";
    }
    else{
        return "False";
...
function howManyTimes(wordsCount,a) {
    var count=0;
...
// Iteration #8: Bonus
let GreatestProduct = (array, adjv) => {
  let highProd = 0;
  let r;
  let col;
  let Offset = (adjv - 1) || 3
  for(r = 0; r < array.length; r ++){
      for(col = 0; col < array[0].length; col ++){
          let cell = array[r][col]
          let prod
          let i
          let j
          prod = cell
          for(i = 1; i <= Offset; i ++ ){
              if(array[r] && array[r][col + i]){
                  prod = prod * array[r][col + i]
              }else{
                  break
              }
          }
          ...
          prod = cell
          for(i = 1; i <= Offset; i ++ ){
              if(array[r + i] && array[r + i][col]){
                  prod = prod * array[r + i][col]
              }else{
                  break
              }
          }
          ...
          prod = cell
          for(i = 1; i <= Offset; i ++ ){
              if(array[r + i] && array[r + i][col + i]){
                  prod = prod * array[r + i][col + i]
              }else{
                  break
              }
          }
