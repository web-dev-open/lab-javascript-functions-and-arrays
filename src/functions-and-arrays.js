...
function averageNumbers(nuberAvg) {
    
      if (nuberAvg.length === 0) {
        return null
      }
    
      let sum = sumNumbers(nuberAvg)
    
      return sum / nuberAvg.length
}
...
function avg(mixedArr) {
  ...
  let sumOfMixedArr = sum(mixedArr)

  return sumOfMixedArr / mixedArr.length
}
