...
function howManyTimes(wordsCount, wordToSearch1) {
  let count = 0;
...
function greatestProduct(matrix) {
  ...
  function calculateProduct(row, col, direction) {
    let product = 1;
  ...
  for (let row = 0; row < numRows; row++) {
    for (let col = 0; col <= numCols - 4; col++) {
      const product = calculateProduct(row, col, 'horizontal');
  ...
  for (let row = 0; row <= numRows - 4; row++) {
    for (let col = 0; col < numCols; col++) {
      const product = calculateProduct(row, col, 'vertical');
      maxProduct = Math.max(maxProduct, product);
    }
  }
...
function greatestProductOfDiagonals(matrix) {
  ...
  function calculateDiagonalProduct(startRow, startCol, rowIncrement, colIncrement) {
    let product = 1;
  ...
  for (let row = 0; row <= numRows - 4; row++) {
    for (let col = 0; col <= numCols - 4; col++) {
      const product = calculateDiagonalProduct(row, col, 1, 1);
      maxProduct = Math.max(maxProduct, product);
    }
  }
