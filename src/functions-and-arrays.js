...
function uniquifyArray(words) {
  ...
  for (const word of words) {
      if (uniqueArray.indexOf(word) === -1) {
          // If the word is not already in the uniqueArray, add it.
...
function howManyTimes(searchword) {
  cnt=0
...
console.log(maxOfTwoNumbers(54,10))
